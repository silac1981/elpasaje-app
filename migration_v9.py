"""seed_oasis_estero_v2.py — Expansión catálogo Oasis del Estero · Mayo 2026
Macetas orgánicas, jardinería, tutores, kits regalo. Idempotente (INSERT OR IGNORE).
"""
import os
import sqlite3
...
# Fotos disponibles por SKU
FOTOS_OE = {
    "OE-MAC-S":    "OE-macetas-blancas-bandeja-negra-frente.jpg",
    "OE-MAC-M":    "OE-macetas-blancas-bandeja-negra-lateral.jpg",
    "OE-MAC-BC-M": "OE-maceta-bicolor-bandeja-blanca.jpg",
    "OE-SEL-M":    "OE-maceta-bicolor-soporte-negro-frente.jpg",
    "OE-KIT-SUC":  "OE-macetas-bandeja-conjunto.jpg",
    "OE-KIT-JAR":  "OE-macetas-bandeja-conjunto.jpg",
}
...
def run():
    ...
    inserted = 0
    for sku, name, cid, price, weight_gr, stock, categoria, description, tipo in PRODUCTOS_OE:
        cur.execute("""
    ...
    # Asignar fotos a los SKUs que las tienen
    for sku, foto in FOTOS_OE.items():
        cur.execute(
    ...
    conn.commit()
    conn.close()
    print(f"seed_oasis_estero_v2 OK — {inserted} productos nuevos insertados")
