...
[data-testid="stTextInput"] input::placeholder,[data-testid="stTextArea"] textarea::placeholder{color:#6B7280!important}
    ...
    tab_panel, tab_fab, tab_mats, tab_cola, tab_archivos, tab_mike = st.tabs(["🛠️ Mi Panel", "📦 Cargar Fabricacion", "🧵 Materiales", "📋 Cola de Pedidos", "📁 Archivos", "🤖 Mike"])
        ...
        if mats.empty:
            ...
            try:
                _lineas_mat = pd.read_sql("""
                    SELECT material_id, STRING_AGG(DISTINCT client_id, ',') AS lineas
