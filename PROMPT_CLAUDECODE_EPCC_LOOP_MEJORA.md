...
- **b)** `coquette.html`: stats de impacto hardcodeadas (`animCount('cnt-p',247)`, horas 1840, kg 18 — línea ~1045). Verificar contra datos reales (¿`production_log`? ¿`stock_movements`?) o marcar explícitamente como copy de marketing aproximado, no dato en vivo. *(pendiente, no investigado todavía)*
